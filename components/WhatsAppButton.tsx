...
const WhatsAppButton: React.FC = () => {
  return (
    <motion.a
      ...
      className="fixed bottom-6 left-6 z-[60] w-14 h-14 md:w-16 md:h-16 bg-[#25D366] rounded-full flex items-center justify-center shadow-2xl hover:scale-110 active:scale-95 transition-transform"
